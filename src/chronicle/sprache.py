...
_STORY_EN = (
    ...
    "- If the material carries no play at all but only such talk, then invent no action "
    "— but do not fall silent either. Say so first, then summarise what was "
    "discussed instead: who plays which character, which rule was settled, what was "
    "agreed for next time. An evening without play still carries decisions the next one "
    "needs.\n"
)
...
_STORY_DE = (
    ...
    "- Gibt die Vorlage kein Spielgeschehen her, sondern nur solches Gespräch, dann "
    "erfinde erst recht keine Handlung — aber schweige auch nicht. Sage es zuerst, "
    "und fasse danach zusammen, was stattdessen besprochen wurde: wer welche "
    "Figur führt, welche Regel geklärt wurde, was für das nächste Mal verabredet ist. "
    "Auch ein Abend ohne Spiel trägt Entscheidungen, die der nächste braucht.\n"
)
...
RUECKBLICK = {
    ENGLISCH: Rueckblicktexte(
        ...
        system_hergang=(
            ...
            f"{ZITAT_REGEL[ENGLISCH]}\n"
            "- Twelve bullet points at most, one per line, each line starting with "
            "'- '. One point is one sentence in the past tense.\n"
            "- Five hundred words at most in total. Less is better: this is read in the "
            "minute before play starts, not at a desk.\n"
            "- Take what matters, not what is complete. Leave out whatever does not "
            "carry into the next evening.\n"
    ...
    DEUTSCH: Rueckblicktexte(
        ...
        system_hergang=(
            ...
            f"{ZITAT_REGEL[DEUTSCH]}\n"
            "- Höchstens zwölf Stichpunkte, je einer pro Zeile, jede Zeile beginnt mit "
            "'- '. Ein Punkt ist ein Satz in der Vergangenheitsform.\n"
            "- Zusammen höchstens fünfhundert Wörter. Weniger ist besser: gelesen wird "
            "das in der Minute vor dem Anpfiff, nicht am Schreibtisch.\n"
            "- Nimm das Wichtigste, nicht das Vollständige. Was den nächsten Abend nicht "
            "trägt, lässt du weg.\n"
